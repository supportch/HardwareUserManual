...
## [9. Board Reference](10.-example-programs/9.-board-reference/)

     [9.1 Board Function Lists](10.-example-programs/9.-board-reference/9.1-board-function-lists.md)

     [9.2 Analog IO Ranges](10.-example-programs/9.-board-reference/9.2-analog-io-ranges.md)

     [9.3. Detailed Board Information](10.-example-programs/9.-board-reference/9.3.-detailed-board-information.md)
